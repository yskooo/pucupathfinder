...
const Team = () => {
  return (
    <section className="bg-[url('/img/team.jpg')] bg-cover relative w-full mx-auto my-auto">
        <div class="py-8 px-4 mx-auto max-w-screen-4xl text-center lg:py-16 lg:px-6" id='team'>
          ...
          <section class="flex flex-col mx-auto">
            ...
            <div className='my-5 '>
            <img class="mx-auto mb-4 w-36 rounded-full object-fit" src="/people/martin.png" alt=""/>
        ...
        <div className='my-5'>
            <img class="mx-auto mb-4 w-40 rounded-full" src="/people/geneva.JPG" alt=""/>
              ...
              <div className='my-5'>
              <img class="mx-auto mb-4 w-36 rounded-full" src="/people/mica.jpg" alt=""/>
                <h1>Simon, Mikaela</h1>
                <p>Research Specialist</p>
              </div>
            <div className='my-5'>
              ...
              <div className='my-5'>
            <img class="mx-auto mb-4 w-40 rounded-full" src="/people/zac.jpg" alt=""/>
                <h1>Valdez, Zac</h1>
                <p>Analyst</p>
              </div>
              <div className='my-5'>
