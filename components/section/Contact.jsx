...
// const Contact = () => {
//   return (
//     <section className="bg-gray-100 mx-auto my-auto flex justify-center items-center h-screen" id='contact'>
...
//             <p className="mb-6 font-light text-gray-500 md:text-lg">Do you have a feature request or you want to feature your research study in this platform?</p>
//             <button>
//               <a href="mailto:pucupathfinder@gmail.com" className="text-blue-900 bg-transparent border-2 border-blue-900 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">
//                 Send an Email
//               </a>
//             </button>
//         </div>
